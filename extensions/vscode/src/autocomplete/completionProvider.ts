  ...
  implements vscode.InlineCompletionItemProvider
{
  private async onError(e: unknown) {
    ...
    let message = "Continuum Autocomplete Error";
    ...
    try {
      ...
      const autocompleteCompletionItem = new vscode.InlineCompletionItem(
        ...
        range,
        {
          ...
          command: "continuum.logAutocompleteOutcome",
      ...
      if (isFim) {
        ...
        // Ghost text acceptance can *technically* be acted upon in the command handler for "continuum.logNextEditOutcomeAccept".
        ...
        const nextEditCompletionItem = new vscode.InlineCompletionItem(
          ...
          ),
          {
            ...
            command: "continuum.logNextEditOutcomeAccept",
