...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close Continuum Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Continuum Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Continuum"
                icon={LinkIcon}
                onClick={() =>
